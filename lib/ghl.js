...
function getMockSummary() {
  return {
    source: "mock",
    pipelineName: "Residential Coatings",
    wonThisMonth: 28450,
    dealsWonCount: 6,
    openValue: 61200,
    openCount: 14,
    biggestDeals: [
      { name: "Prater Auto — shop floor", value: 14800, stage: "Estimate sent" },
      { name: "Doyle — 4-car metallic", value: 8900, stage: "Follow-up" },
      { name: "Callahan — 3-car flake", value: 6200, stage: "Estimate sent" },
      { name: "Nguyen — 2-car solid", value: 3400, stage: "New lead" },
      { name: "Simmons — 2-car flake", value: 3100, stage: "Contract out" },
    ],
  };
}
