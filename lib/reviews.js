...
function getMockSummary() {
  return {
    ...
    newReviews: 5,
    conversionRate: 36,
    averageRatingNew: 4.8,
    latest: [
      { author: "Denise K.", rating: 5, comment: "Floor looks amazing, crew was in and out in two days." },
      { author: "Marcus T.", rating: 5, comment: "Best garage upgrade we've made. Highly recommend." },
      { author: "Angela R.", rating: 4, comment: "Great work, minor scheduling delay." },
    ],
  };
}
